...
\section{Dettagli dei casi d'uso specifici}

\subsection{Utente: Creazione di una nuova Issue}
...
\subsection{Amministratore: Aggiunta di un nuovo utente}
...
\subsection{Utente: Aggiunta di un commento a una Issue esistente}
